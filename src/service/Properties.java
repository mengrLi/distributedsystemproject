...
public class Properties {
    ...
    public static final String FRONTEND_INET = "192.168.0.152";//192.168.1.145";
    ...
    public static final String RM_1_INET = "192.168.0.152";//192.168.1.145";
    public static final String RM_2_INET = "192.168.1.146";
    public static final String RM_3_INET = "192.168.1.105";
